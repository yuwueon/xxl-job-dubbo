...
public class XxlJobExecutor implements ApplicationContextAware {
    ...
    public static void addAdminBiz(AdminBiz adminBiz){
    	if (adminBizList == null) {
            adminBizList = new ArrayList<AdminBiz>();
        }
        adminBizList.add(adminBiz);
    ...
    public static IJobHandler loadDubboJobHandler(String zkAddress,TriggerParam triggerParam){
    	...
    	IJobHandler jobHandler = new DubboJobHandler(zkAddress , triggerParam);

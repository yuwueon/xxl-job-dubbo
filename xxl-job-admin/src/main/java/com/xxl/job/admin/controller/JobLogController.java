...
public class JobLogController {
	...
	public ReturnT<LogResult> logDetailCat(String executorAddress, long triggerTime, int logId, int fromLineNum){
		try {
			...
			if(executorAddress.equals(XxlJobAdminConfig.getAdminConfig().getDubbozkAddress())){
				executorBiz = XxlJobDynamicScheduler.getDubboEecutorBiz(executorAddress);
			}else{
				executorBiz = XxlJobDynamicScheduler.getExecutorBiz(executorAddress);
			}
